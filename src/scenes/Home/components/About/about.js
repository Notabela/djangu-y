            ...
            <Container fluid={true} id="about">
                ...
                <Container fluid={true} className="text-center" id='about-grid'>
                    <Row className="about-top">
                        <Col sm="6" className="about-box about-1-box">
                            <p className="about-number">1</p>
                            <p>Télécharger l'application</p>
                        </Col>
                        <Col sm="6" className="about-box about-2-box">
                    ...
                    <Row className="about-bottom"> 
                        <Col sm="6" className="about-box about-3-box">
                            <p className="about-number">3</p>
                            <p>Choisir son cours</p>
                        </Col>
                        <Col sm="6" className="about-box about-4-box">
